...
import { borderRadiusStyle, Paragraph } from '../../utils';
        ...
        return ( 
            <ScrollView style={{ flex: 1, }} contentContainerStyle={{alignItems: 'center'}} >
                <View style={styles.pageContainer} >
                    ...
                    <Text style={{ fontSize: scale(20), color: '#4b5320',
                     textDecorationLine: 'underline', fontWeight: 'bold', 
                     marginBottom: scale(10) }} >דברים שחשוב לדעת: </Text>
...
const ImportantInfoParagraph = ({ text }) => (
    <View style={[styles.paragraph, { marginVertical: scale(5), marginStart: scale(12) }]} >
        ...
        <Text style={{ fontSize: scale(15) }} >{text}</Text>
    </View>
)
